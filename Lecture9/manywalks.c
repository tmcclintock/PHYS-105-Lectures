...
int main(){
  ...
  int i,j; //Count variables we will use

  //Here is the array that contains how many
  //walks of a given length occur
  //Index 0 corresponds to a walk of -10
  //Index N_steps+1 is a walk of +1
  //Thus there are 2*N_steps + 1 elements
  ...
  for(i=0; i<N_walks; i++){
    p = 0;
    //Each walk is N = N_steps - [0,1]
    //so that some walks are even and some are odd
  ...
  //Loop over all distances and write the 
  //data to a file and the screen
